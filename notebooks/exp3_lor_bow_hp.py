...
def preprocess_text(text):
    ...
    text = text.lower() # Convert to lowercasae
...
def load_and_prepare_data(filepath):
    """Loads, preprocesses, and vectorizes thee dataset."""
    ...
    # conver text data tot TF-IDF vectors
...
# Train & Log Model
# ==========================
def train_and_log_model(X_train, X_test, y_train, y_test, vecctorizer):
    ...
    with mlflow.start_run():
        ...
        # Log all hyperpparameter tuning runs
